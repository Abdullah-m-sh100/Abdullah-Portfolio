        ...
        <div className="about-content">
          <div className="about-text reveal">
            <p className="about-paragraph">
              Hello! I'm <span className="highlight">Abdullah M. Abu Shamla</span>, 
              a passionate React.js Front-End Developer dedicated to building 
            ...
            <p className="about-paragraph">
              ...
              about user experience, performance, and attention to detail. My goal 
              is to create products that not only look great but also provide 
            ...
            <p className="about-paragraph">
              ...
              while reading about the latest trends in front-end development.
            </p>
          </div>
